...
public class ArenaEditorExecutor extends CustomCommandExecutor {
    ...
    @MCCommand(cmds={"ds","deletespawn"}, admin=true, usage="deleteSpawn <index>")
    ...
    @MCCommand(cmds={"as","addspawn"}, admin=true, min=2,
            usage="addspawn <mob/item/spawnGroup> [buffs or effects] [number] [fs=first spawn time] [rs=respawn time] [ds=despawn time] [index|i=<index>]")
    ...
    @MCCommand(cmds={"ss","setspawn"}, admin=true, min=2,
            usage="setspawn <mob/item/spawnGroup> [buffs or effects] [number] [fs=first spawn time] [rs=respawn time] [ds=despawn time] [index|i=<index>]")
    ...
    @MCCommand(cmds={"ab","addBlock"}, admin=true,
            usage="addBlock [number] [fs=first spawn time] [rt=respawn time] [trigger=<trigger type>] [resetTo=<block>] [index]")
